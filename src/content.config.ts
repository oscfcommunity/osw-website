      ...
      application: z
        .object({
          ...
          instructions: z
            ...
            .max(
              1000,
              'Application instructions must not exceed 1000 characters'
            )
            .optional(),
        ...
        .object({
          ...
          cta: z.object({
            primary: z.object({
              ...
              link: z.string().url('Primary CTA link must be a valid URL'),
      ...
      jobs: z
        .object({
          ...
          sectionBackground: z
            ...
            .regex(
              /^bg-/,
              'Background must be a valid Tailwind class starting with bg-'
            )
            .default('bg-base-100'),
        ...
        .object({
          ...
          ctaButton: z.object({
            ...
            link: z
              ...
              .regex(/^\//, 'Link must start with / for internal links'),
            style: z
              .enum(['primary', 'secondary', 'accent', 'neutral', 'info'])
              .default('secondary'),
            size: z.enum(['sm', 'md', 'lg']).default('lg'),
          }),
          sectionBackground: z
...
const eventCardConfig = defineCollection({
  ...
  schema: z.object({
    ...
    button: z.object({
      ...
      text: z.string().default('View Event'),
    }),
  }),
});
